...
So, where possible, it makes sense to publish analysis for anyone to find. Then everyone who needs it can find it, benefit from it, and avoid duplicating it. The people who are able to find it and avoid duplicating it may well be people from your own institution in the future---I've [written before](../managing-public-sector-knowledge/managing-public-sector-knowledge.qmd) about how the public sector is not good at maintaining the stock of knowledge, but making that knowledge accessible to the most powerful search engines in the world means it is far less likely to disappear or be inefficiently duplicated.
...
It seems like there's plenty of room to improve communication and co-ordination in the public sector. I've shared a few suggestions focused on four areas: making your analysis public by default avoids costly bilateral co-ordination, gets you free help from others, and helps avoid duplication; working asynchronously avoids bottlenecks, empowers staff, and promotes transparency; thinking carefully about who owns key trade-offs can prevent a lot of inefficient back-and-forth; and battle-tested project management practices can promote delivery and action. Got better ideas? Let me know!
