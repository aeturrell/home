...
Well, the answer is that an under-7GB model running locally on a MacBook can do this job just as well! Using the very convenient MLX version of Qwen3-VL-4B-Instruct-8Bit (details on the [MLX VL package here](https://github.com/Blaizzy/mlx-vlm), and info on [the model is here](https://huggingface.co/mlx-community/Qwen3-VL-4B-Instruct-8bit)), this is the command:
...
Peak memory: 6.248 GB
```

While a MacBook is not a mobile phone or a bespoke wearable, it's a step along the way. Impressive stuff!
